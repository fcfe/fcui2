...
define(function (require) {
    ...
    return React.createClass({
        ...
        render: function () {
            ...
            return (
                <Layer {...layerProp}>
                    <div {...cTools.containerBaseProps('warninglayer', this)} onClick={this.onClick}>
                        <div ref="arrow">
                            <div className="arrow-bg"></div>
                        </div>
                        <div className="warninglayer-content" dangerouslySetInnerHTML={{__html: this.props.message}}></div>
                    </div>
                </Layer>
            );
        }
