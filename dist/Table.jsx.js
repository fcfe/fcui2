...
define(function (require) {
    ...
    return React.createClass({
        ...
        onHorizontalScroll: function onHorizontalScroll() {
        ...
        onHorizontalScroll1: function onHorizontalScroll1(e) {
            if (!this.refs || !this.refs.normalFieldsScrollContainer) return;
        ...
        onRendered: function onRendered() {
            ...
            if (shadowNormalFieldsScrollContainer) {
                ...
                table.style.maxWidth = shadowTable.style.maxWidth = table.style.minWidth = shadowTable.style.minWidth = componentWidth + 'px';
            }
            // 修正表头尺寸
            ...
            if (shadowNormalFieldsScrollContainer) {
                ...
                shadowTableContainer.style.height = shadowNormalFieldsScrollContainer.offsetHeight - dataAreaHeight + shadowMessageBar.offsetHeight - 1 + 'px';
                container.style.paddingTop = shadowNormalFieldsScrollContainer.offsetHeight - dataAreaHeight - getTableHeaderHeight(this.refs.tbody) + 'px';
            } else {
        ...
        onRowSelect: function onRowSelect(e) {
            ...
            tableValue.selected = tools.updateSelected(parseInt(util.getDataset(e.target).uiCmd || e.target.value, 10), e.target.checked, e.target.value, this.___getValue___(), this.props.datasource);
    ...
    function normalRenderer(me) {
        return React.createElement(
            'div',
            cTools.containerBaseProps('table', me),
            React.createElement(
                'div',
                { ref: 'realTableContainer', className: 'table-container' },
                React.createElement(
                    'table',
                    { ref: 'table', cellSpacing: '0', cellPadding: '0' },
            ...
            React.createElement(
                'div',
                { ref: 'shadowTableContainer', className: 'shadow-container' },
                React.createElement(
                    'table',
                    { ref: 'shadowTable', cellSpacing: '0', cellPadding: '0' },
                    factory.colgroupFactory(me),
                    React.createElement(
                        'tbody',
                        { ref: 'tbody' },
    ...
    function hScrollRenderer(me) {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    'div',
                    { ref: 'fixedFieldsContainer', className: 'fixed-fields-container' },
                    React.createElement(
                        'table',
                        { ref: 'fixedTable', cellSpacing: '0', cellPadding: '0' },
                        factory.colgroupFactory(me),
                        React.createElement(
                            'tbody',
                            null,
                ...
                React.createElement(
                    'div',
                    normalFieldsScrollContainerProps,
                    React.createElement(
                        'div',
                        { ref: 'normalFieldsContainer' },
                        React.createElement(
                            'table',
                            { ref: 'table', cellSpacing: '0', cellPadding: '0' },
                            factory.colgroupFactory(me),
            ...
            React.createElement(
                'div',
                { ref: 'shadowTableContainer', className: 'shadow-container-with-scroll' },
                React.createElement(
                    'div',
                    { ref: 'shadowFixedFieldsContainer', className: 'fixed-fields-container' },
                    React.createElement(
                        'table',
                        { ref: 'shadowFixedTable', cellSpacing: '0', cellPadding: '0' },
                        factory.colgroupFactory(me),
                        React.createElement(
                            'tbody',
                            null,
                ...
                React.createElement(
                    'div',
                    shadowNormalFieldsScrollContainerProps,
                    React.createElement(
                        'div',
                        { ref: 'shadowNormalFieldsContainer' },
                        React.createElement(
                            'table',
                            { ref: 'shadowTable', cellSpacing: '0', cellPadding: '0' },
                            factory.colgroupFactory(me),
                ...
                React.createElement(
                    'div',
                    { className: 'message-bar-in-scrolling-header', ref: 'shadowMessageBar' },
                    React.createElement(
                        'table',
    ...
    function getTableDataAreaHeight(tbody) {
        ...
        for (var i = 0; i < tbody.childNodes.length; i++) {
            ...
            result += tr.className.indexOf('tr-data') > -1 || tr.className.indexOf('tr-summary') > -1 ? tr.offsetHeight : 0;
        }
        return result;
    }
