...
define(function (require) {
    ...
    return React.createClass({
        ...
        render: function render() {
            var selected = tools.getSelectedState(this.props.id, this.props.value, this.props.parent.props.noLinkage);
            var prop = {
            ...
            if (this.props.type === 'single') {
                return React.createElement(Radio, prop);
            }
            return React.createElement(CheckBox, prop);
        }
    });
});