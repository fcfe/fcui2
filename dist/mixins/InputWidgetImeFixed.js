...
define(function (require) {
    ...
    return {
        ...
        ___syncValue___: function ___syncValue___(props) {
            // 键盘keyup过了一段时间，但是外部还没有刷新组件，手动同步一下value
            props = props || this.props;
            var value = props.value;
            // 外部没有导入value或导入的value和输入框的相同
            if (typeof value == null || value === undefined || !this.refs || !this.refs.inputbox || value + '' === this.refs.inputbox.value + '') {
        ...
        ___onCompositionStart___: function ___onCompositionStart___(e) {
            this.___imeStart___ = true;
        },
        ___onCompositionEnd___: function ___onCompositionEnd___(e) {
            this.___imeStart___ = false;
            /*
             * 背景：
        ...
        ___onKeyDown___: function ___onKeyDown___(e) {
            this.___isPressing___ = true;
        },
        ___onKeyUp___: function ___onKeyUp___(e) {
            this.___isPressing___ = false;
        ...
        ___onInput___: function ___onInput___(e) {
            // 在window的chrome中：
        ...
        ______callDispatch______: function ______callDispatch______(e) {
            var me = this;
