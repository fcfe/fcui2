...
define(function (require) {
    ...
    return {
         ...
         * * 否则，返回null
         */
        ___getValue___: function ___getValue___() {
            var valueField = this.props.___uitype___ === 'checkbox' || this.props.___uitype___ === 'radio' ? 'checked' : 'value';
            // 对radio进行特殊处理
            // 由于操作radio，可能引起其他radio值的改变，因此如果radio已经渲染出来了，
            // 此方法应该返回dom自带的值
            if (this.props.___uitype___ === 'radio' && this.refs.hasOwnProperty('inputbox') && typeof this.props.name === 'string' && this.props.name.length > 0) {
                return this.refs.inputbox.checked;
            }
            // 常规input组件
            if (this.props.hasOwnProperty(valueField) && this.props[valueField] !== undefined && this.props[valueField] != null) {
         ...
         */
        ___dispatchChange___: function ___dispatchChange___(e, value, lastValue) {
