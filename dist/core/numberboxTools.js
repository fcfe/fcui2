    ...
    return {
        ...
        charFilter: function charFilter(value) {
            ...
            for (var i = 0; i < value.length; i++) {
                ...
                if (str.indexOf(char) < 0 || char === '-' && i > 0 || char === '.' && result.indexOf('.') > -1) {
                    continue;
                }
                result += char;
            }
         ...
         */
        regionFilter: function regionFilter(value, min, max) {
         ...
         */
        fixed: function fixed(value, _fixed) {
            value = typeof value === 'string' || typeof value === 'number' ? value + '' : '';
         ...
         */
        numberFormater: function numberFormater(value, config) {
            config = config || {};
