...
define(function (require) {
    ...
    return {
         ...
         */
        getLeafItem: function getLeafItem(datasource, indexs) {
         ...
         */
        getNodeSelectInfo: function getNodeSelectInfo(item, selectedHash, index, loadCache) {
            loadCache = loadCache || {};
            index = index || '';
            // 已缓存
         ...
         */
        getLeafCount: function getLeafCount(datasource) {
            var result = 0;
            getCount(datasource);
         ...
         */
        targetAsyncLeaf: function targetAsyncLeaf(selected, selectorEngine, datasource) {
            var result = false;
            doing(datasource);
            return result;
            function doing(arr) {
        ...
        dualTreeSelectorEngine: {
             ...
             */
            select: function select(selected, item) {
             ...
             */
            unselect: function unselect(selected, item) {
