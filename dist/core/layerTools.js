...
define(function (require) {
    ...
    return {
         ...
         */
        getLayerPosition: function getLayerPosition(layer, anchor, layerLocation, skin) {
            // 准备数据
            ...
            // 只在下方显示
                ...
                // 上方优先显示
                    ...
                    // 下方优先显示
                            ...
                            result.top = anchorPosition.y + anchorHeight + layerHeight >= document.documentElement.clientHeight ? tempPosition.top : tempPosition.bottom;
                        }
            // 只在左侧显示
            ...
            // 只在右侧显示
                ...
                // 左侧优先显示
                        ...
                        result.left = anchorPosition.left + anchorWidth - layerWidth > 0 ? tempPosition.left : tempPosition.right;
                    }
                    // 右侧优先显示
                    else {
                            result.left = anchorPosition.x + layerWidth >= document.documentElement.clientWidth ? tempPosition.left : tempPosition.right;
                        }
