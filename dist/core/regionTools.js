...
define(function (require) {
    ...
    var filiation = {
        ...
        '994': [4, 8, 12],
        '28': [226, 252, 247, 250, 232, 236, 224, 225, 233, 228, 234, 227, 229, 231, 235, 230, 237, 251, 254, 253, 238],
    ...
    return {
         ...
         */
        getSelectedState: function getSelectedState(id, value, noLinkage) {
            var result = {
                checked: false,
                indeterminate: false,
                selected: 0,
         ...
         */
        addValue: function addValue(key, value, noLinkage) {
            var me = this;
            // 添加当前
            value[key] = true;
            if (noLinkage) {
         ...
         */
        deleteValue: function deleteValue(key, value, noLinkage) {
            // 删除当前
            delete value[key];
            if (noLinkage) {
                return;
