...
define(function (require) {
    ...
    return {
         ...
         * @return {Object} 校验机对象
         */
        validationFactory: function validationFactory(validations) {
         ...
         */
        isCallbackExist: function isCallbackExist(me, callback) {
            var name = me.props.name;
            var form = me.context.___form___;
            if (typeof name !== 'string' || name.length === 0 || (typeof form === 'undefined' ? 'undefined' : _typeof(form)) !== 'object' || typeof form[callback] !== 'function') {
                return false;
            }
            return true;
        },
         ...
         */
        rulesFactory: function rulesFactory(me, rules) {
            var result = [];
