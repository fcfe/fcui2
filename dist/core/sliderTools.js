...
define(function (require) {
    ...
    */
    ...
    return {
         ...
         */
        value2position: function value2position(value, me, margin) {
         ...
         */
        position2value: function position2value(pos, me, margin) {
            var min = isNaN(me.props.min) ? 0 : me.props.min * 1;
            var max = isNaN(me.props.max) ? 100 : me.props.max * 1;
            var width = getContainerWidth(me);
            if (min > max) {
         ...
         */
        displayValue: function displayValue(value, me) {
            var min = isNaN(me.props.min) ? 0 : me.props.min * 1;
            var max = isNaN(me.props.max) ? 100 : me.props.max * 1;
            ...
            var step = _getValidStep(me.props.step);
        ...
        * @return {Number} 对应的有效步长
        */
        getValidStep: function getValidStep(step) {
            return _getValidStep(step);
        }
    };
});