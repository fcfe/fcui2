...
define(function (require) {
    ...
    return {
         ...
         */
        required: function required(value, skip) {
            return {
        ...
        matchRegexp: function matchRegexp(value, regexp) {
            return {
                isValid: _matchRegexp(value, regexp)
            };
        },
        /**
         ...
         * @return {ValidateResult} 校验结果对象
         */
        notMatchRegexp: function notMatchRegexp(value, regexp) {
            return {
        ...
        isEmail: function isEmail(value) {
            ...
            return {
                isValid: _matchRegexp(value, reg),
                template: '请输入正确的邮件地址'
            };
        },
        /**
         ...
         * @return {ValidateResult} 校验结果对象
         */
        isProtocolUrl: function isProtocolUrl(value) {
            value = value && value.trim();
         ...
         * @return {ValidateResult} 校验结果对象
         */
        isAnyPhone: function isAnyPhone(value) {
            var reg_phone = /^1[34578]\d{9}$/ig;
            var reg_telephone = /^(0\d{2,3}-)?\d+$/ig;
            return {
                isValid: _matchRegexp(value, reg_phone) || _matchRegexp(value, reg_telephone),
                template: '请输入正确的电话号码'
            };
        },
        /**
        ...
        isNumeric: function isNumeric(value) {
            ...
            if (typeof value === 'number') {
                ...
                isValid = _matchRegexp(value, /^[-+]?(?:\d*[.])?\d+$/);
            }
            return {
                isValid: isValid,
                template: '请输入数字'
        ...
        isAlpha: function isAlpha(value) {
            return {
                isValid: _matchRegexp(value, /^[A-Z]+$/i),
                template: '请输入英文字母'
            };
        },
        /**
        ...
        isAlphanumeric: function isAlphanumeric(value) {
            return {
                isValid: _matchRegexp(value, /^[0-9A-Z_]+$/i),
         ...
         * @return {ValidateResult} 校验结果对象
         */
        maxByteLength: function maxByteLength(value, length) {
            return {
         ...
         * @return {ValidateResult} 校验结果对象
         */
        minByteLength: function minByteLength(value, length) {
            return {
                isValid: !isExisty(value) || getLengthInBytes(value) > length - 1,
