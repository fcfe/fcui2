...
define(function (require) {
    ...
    return React.createClass({
        ...
        fixedContainer: function fixedContainer(props) {
            ...
            layer.className = 'fcui2-layer fcui2-layer-' + (typeof props.skin === 'string' && props.skin.length ? props.skin : 'normal') + (typeof props.className === 'string' && props.className.length ? ' ' + props.className : '');
            var cssText = '';
