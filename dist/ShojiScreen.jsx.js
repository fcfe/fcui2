    ...
    return React.createClass({
        ...
        renderSubTree: function renderSubTree(props) {
            ...
            if (props.isOpen) {
                ...
                this.___container___.className = 'fcui2-shojiscreen' + (typeof className === 'string' && className ? ' ' + className : '') + ' fcui2-shojiscreen-' + (typeof skin === 'string' && skin ? skin : 'normal') + (props.className ? ' ' + props.className : '') + (props.showFootBar ? '' : ' fcui2-shojiscreen-hide-foot-bar');
