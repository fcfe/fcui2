    ...
    return React.createClass({
        ...
        buttonClickHandler: function (e) {
            ...
            switch (e.value) {
                ...
                case 'change dropdownlist datasource':
                    this.refs.dropdownlist.setState({datasource: config.listDatasource()});
                    break;
                default:
                    // 调用外部状态机
        ...
        render: function () {
            return (<div>
                ...
                <hr/>
                Example1:
                <TextBox ref="textbox" {...this.props.textBoxProp} checkout={[checker.maxLength(10, '最多10个字符')]} onChange={this.textBoxChangeHandler}/>
                ...
                <hr/>
                Example3:
                <DropDownList ref="dropdownlist" onClick={this.listClickHandler} label="编辑" datasource={config.listDatasource()}/>
                ...
                <hr/>
                Example5:
                <ComboList cmd="combolist" icon="font-icon-dot" datasource={config.listDatasource()} onClick={this.listClickHandler}/>
            </div>);
        }
    });
});
